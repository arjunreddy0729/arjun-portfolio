...
type Mouse = { x: number; y: number; radius: number };

/** Lives at module scope: the React Compiler cannot compile inline classes. */
class Particle {
    x: number;
    y: number;
    vx: number;
    ...
    update(w: number, h: number, mouse: Mouse, dpr: number) {
